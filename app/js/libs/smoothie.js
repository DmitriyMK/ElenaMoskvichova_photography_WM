{
    ...
    class Item {
        constructor(el) {
            ...
            this.DOM = {el: el};
            // the inner image
            this.DOM.image = this.DOM.el.querySelector('.photo__item');
            this.renderedStyles = {
    ...
    class SmoothScroll {
        constructor() {
            ...
            this.items = [];
            [...this.DOM.main.querySelectorAll('.photo__box > .photo__item')].forEach(item => this.items.push(new Item(item)));
    ...
    const preloadImages = () => {
        return new Promise((resolve, reject) => {
            imagesLoaded(document.querySelectorAll('.photo__img'), {background: true}, resolve);
        });
    };
