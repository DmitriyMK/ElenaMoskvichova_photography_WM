...
if (
  (browser.name === 'Chrome' && browser.version > 63) || 
  (browser.name === 'Firefox' && browser.version > 57) || 
  ...
  if (document.documentElement.clientWidth > 1024) {
    class App {
      ...
      `
        ...
        const displacementImage = new BABYLON.Texture('../img/displacement.jpg', this.scene, true)
        ...
        for (let i = 0; i < numImages; i++) {
          ...
          this.planesImg[i] = baseMesh.clone(`Image${i.toString().padStart(1, '0')}`)
      ...
      animateFisheye({ value }) {
        TweenMax.to(this.fisheyeDistortion, 0.3, { value: value * 0.007 })
      }
